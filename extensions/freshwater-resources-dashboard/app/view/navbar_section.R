...
ui <- function(id) {
  ...
  gridPanel(
    ...
    areas = list(
      default = c(
        "logo logo_2 info mobile_controls",
        "separator separator separator separator",
        "title title title title",
        "menu menu menu menu",
        "cta cta cta cta"
      ),
      l = "logo logo_2 separator title mobile_controls . menu info cta"
    ),
    ...
    logo_2 = img(
      class = "appsilon_logo",
      src = "static/img/d4g_light.png",
      onclick = "window.open('http://data4good.appsilon.com', '_blank')"
    ),
    ...
    title = div(
      "Fresh Water Resources Dashboard",
