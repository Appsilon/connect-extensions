...
test_that("trend_data_process returns the correct output",
          {
            ...
            expected_comment <- c("<i>Origination year</i>",
                                  "<i>100% increase from previous year</i>",
                                  "<i>50% increase from previous year</i>")
            processed_data <- trend_data_process(raw_data = raw_data_4_test,
            ...
            processed_data <- trend_data_process(raw_data = raw_data2_4_test,
